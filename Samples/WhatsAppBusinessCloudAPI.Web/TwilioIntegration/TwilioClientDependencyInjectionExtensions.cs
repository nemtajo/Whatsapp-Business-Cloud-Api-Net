...
public static class TwilioClientDependencyInjectionExtensions
{
    ...
    public static IServiceCollection AddTwilioClient(this IServiceCollection services)
    {
        ...
        // Register TwilioRegulatoryBundleOptions for integration services
        services.Configure<TwilioRegulatoryBundleOptions>(options =>
        {
            var configuration = services.BuildServiceProvider().GetRequiredService<IConfiguration>();
            configuration.GetSection("Twilio:RegulatoryBundles").Bind(options);
        });
